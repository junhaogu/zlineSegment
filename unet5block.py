...
Original file is located at
    https://colab.research.google.com/drive/1i70uCGoQkVtPWrg1IxY3Ywy03fv1c-7x
"""
...
class unet5block(nn.Module):

    def __init__(self, in_channels=3, out_channels=1, init_features=20):
